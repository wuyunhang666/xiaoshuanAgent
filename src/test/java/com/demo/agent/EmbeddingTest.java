...
public class EmbeddingTest {
    ...
    //并使用默认的文档解析器对文档进行解析
        Document document1 = FileSystemDocumentLoader.loadDocument("D:/医院信息.md");
        Document document2 = FileSystemDocumentLoader.loadDocument("D:/科室信息.md");
        Document document3 = FileSystemDocumentLoader.loadDocument("D:/神经内科.md");
        Document document4 = FileSystemDocumentLoader.loadDocument("D:/口腔科.md");
